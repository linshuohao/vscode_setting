...
function previewProblem(input, isSideMode = false) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const descString = yield leetCodeExecutor_1.leetCodeExecutor.getDescription(node.id);
...
function showSolution(input) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const solution = yield leetCodeExecutor_1.leetCodeExecutor.showSolution(problemInput, language);
...
function showProblemInternal(node) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield leetCodeExecutor_1.leetCodeExecutor.showProblem(node, language, finalPath, descriptionConfig.showInComment);
            const promises = [
